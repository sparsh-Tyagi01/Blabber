        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col w-[50vw] h-[20vh]">
            <div className="flex flex-col items-center">
              <label
                htmlFor="data"
                className="text-white flex justify-center items-center text-xl"
              >
                <User size={35} />
                Create Your Post
              </label>
            ...
            <input
              ...
              required
              className="text-white focus:outline-none text-2xl w-[40vw] mt-2 ml-4"
            />
          </div>
          <div className="flex justify-around">
            <input
              ...
              onChange={handleChange}
              className="text-white focus:outline-none border-1 border-white rounded-2xl p-1 w-[18vw] shadow-2xl shadow-white"
            />
            <input
              type="text"
              ...
              onChange={handleChange}
              required
              className="focus:outline-none text-white border-1 border-white rounded-2xl p-1 w-[18vw] shadow-2xl shadow-white"
            />
          </div>
          <div className="w-[50vw] text-white flex justify-around mt-5">
            <div>
              <label htmlFor="category" className="text-white mr-2">
                Category:
              </label>
              <select
                id="category"
                ...
                onChange={handleChange}
                required
                className="border-1 rounded-sm border-white focus:outline-none"
              >
            ...
            <button
              type="submit"
              className="text-xl bg-gray-600 rounded-xl px-2 py-1 border-1 cursor-pointer"
            >
              Post
            </button>
          </div>
